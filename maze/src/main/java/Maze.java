...
//        this.setLocationRelativeTo(null);
    ...
    public List<Vertex>getNeighbors(Vertex currentVertex){
        ...
        neighbors.add(new Vertex(currentVertex.getRow(),currentVertex.getColumn()-1));
        neighbors.add(new Vertex(currentVertex.getRow(),currentVertex.getColumn()+1));
        neighbors.add(new Vertex(currentVertex.getRow()-1,currentVertex.getColumn()));
        neighbors.add(new Vertex(currentVertex.getRow()+1,currentVertex.getColumn()));
        isValid(neighbors);
        return neighbors;
    }

    public void isValid(List<Vertex>neighbors){
        List<Vertex> copyList = new ArrayList<>(neighbors);
